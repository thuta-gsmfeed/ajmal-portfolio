...
export default function Home(){return <><a className="skip-link" href="#main">Skip to content</a><Loader/><Header/><SectionRail/><main id="main" className="site-content"><HeroSection/><AboutSection/><BusinessesSection/> {/* <ImmersiveSplineSection/> */} {/* <CoolmixDeliverySection/> */} <JourneySection/>{/* <ParticleJourneySection/> */}{/* <MagnifierRevealSection/> */}<div className="journey-ventures-transition" aria-hidden="true" /><VenturesSection/><GlobalNetworkSection/>{/*<ProductsSection/> */} {/*<DubaiYachtSection/> */} {/* <PhilosophySection/> */}{/* <NowNextSection/> */}<TrustedPartnershipsSection/>{/* <ContactSection/> */}<FutureTogetherSection/></main>{/* <Footer/> */}</>}
